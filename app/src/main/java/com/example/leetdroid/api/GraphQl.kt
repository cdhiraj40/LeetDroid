...
object GraphQl {
    ...
    //"Content-Type", "application/json"
    const val DISCUSS_ITEM_FORM =
        "{\"operationName\":\"DiscussTopic\",\"variables\":{\"topicId\":%d},\"query\":\"query DiscussTopic(\$topicId: Int!) {  topic(id: \$topicId) {    id    viewCount      title    post {      ...DiscussPost      }    }}fragment DiscussPost on PostNode {  id  voteCount  content  updationDate  author {   username    profile {      userAvatar      reputation     }    }}\"}"
